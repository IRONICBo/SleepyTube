...
#### Feature 1.1: Basic Audio Stabilization ⭐⭐⭐
**Status**: Must Have  
**Effort**: 3 days  
**Dependencies**: None
...
Video → MediaElementSource → Compressor → Limiter → Destination
```

#### Feature 1.2: Sleep Mode Toggle Button ⭐⭐⭐
**Status**: Must Have  
**Effort**: 2 days  
**Dependencies**: None
...
#### Feature 1.3: Configuration Storage ⭐⭐
**Status**: Must Have  
**Effort**: 1 day  
**Dependencies**: None
...
#### Feature 2.1: Compression Strength Slider ⭐⭐⭐
**Status**: Must Have  
**Effort**: 1 day  
...
#### Feature 2.2: Sleep EQ (Frequency Softening) ⭐⭐
**Status**: Should Have  
**Effort**: 2 days  
**Dependencies**: Feature 1.1
...
```javascript
// EQ chain
Source → Low-shelf filter → High-shelf filter → Peaking filter → ...
```

#### Feature 2.3: Control Panel UI ⭐⭐
**Status**: Should Have  
**Effort**: 2 days  
...
#### Feature 3.1: Auto Gain Control (AGC) ⭐⭐⭐
**Status**: Must Have  
**Effort**: 3 days  
**Dependencies**: Feature 1.1
...
#### Feature 3.3: Sleep Score Badge (MVP) ⭐⭐
**Status**: Should Have  
**Effort**: 4 days  
...
#### Feature 4.1: Thumbnail Sleep Scores ⭐
**Status**: Nice to Have  
**Effort**: 3 days  
...
#### Feature 4.2: Advanced Sleep Panel ⭐
**Status**: Nice to Have  
**Effort**: 2 days  
...
│                                             │
│  ┌──────────────────┐  ┌───────────────┐  │
│  │ AGC (Auto Gain)  │  │ Voice Focus   │  │
│  │                  │  │ (Multiband)   │  │
│  └──────────────────┘  └───────────────┘  │
│                                             │
│  ┌──────────────────────────────────────┐  │
│  │ Sleep Score (Video Player Badge)     │  │
│  │ - Peak density                       │  │
│  │ - Loudness range                     │  │
│  └──────────────────────────────────────┘  │
│                                             │
...
**Minimum features for v1.0 public release**:
...
### Nice to Have 💡
- Thumbnail badges (defer to v1.1)
